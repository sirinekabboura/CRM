 ...
 */
final class Version20220424010316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE poule (nom_poule VARCHAR(255) NOT NULL, nomT VARCHAR(255) NOT NULL, INDEX IDX_FA1FEB405635336 (nomT), PRIMARY KEY(nom_poule)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournoi (nom_t VARCHAR(255) NOT NULL, categories_id INT DEFAULT NULL, id_t INT NOT NULL, emplacement_t VARCHAR(255) NOT NULL, date_t DATE NOT NULL, INDEX IDX_18AFD9DFA21214B7 (categories_id), PRIMARY KEY(nom_t)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
