 ...
 */
final class Version20220424012650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category (name VARCHAR(255) NOT NULL, id INT NOT NULL, PRIMARY KEY(name)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE matchs (id_match INT AUTO_INCREMENT NOT NULL, nom_poule VARCHAR(255) DEFAULT NULL, nom_equipe_a VARCHAR(50) NOT NULL, nom_equipe_b VARCHAR(50) NOT NULL, date_match DATE NOT NULL, emplacement VARCHAR(50) NOT NULL, INDEX IDX_6B1E604150E777D5 (nom_poule), PRIMARY KEY(id_match)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE poule (nom_poule VARCHAR(255) NOT NULL, nom_t VARCHAR(255) NOT NULL, INDEX IDX_FA1FEB40A92175A9 (nom_t), PRIMARY KEY(nom_poule)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tournoi (nom_t VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, id_t INT NOT NULL, emplacement_t VARCHAR(255) NOT NULL, date_t DATE NOT NULL, INDEX IDX_18AFD9DF5E237E06 (name), PRIMARY KEY(nom_t)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE poule ADD CONSTRAINT FK_FA1FEB40A92175A9 FOREIGN KEY (nom_t) REFERENCES tournoi (nom_t)');
        ...
        $this->addSql('ALTER TABLE tournoi ADD CONSTRAINT FK_18AFD9DF5E237E06 FOREIGN KEY (name) REFERENCES category (name)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE tournoi DROP FOREIGN KEY FK_18AFD9DF5E237E06');
        ...
        $this->addSql('ALTER TABLE poule DROP FOREIGN KEY FK_FA1FEB40A92175A9');
