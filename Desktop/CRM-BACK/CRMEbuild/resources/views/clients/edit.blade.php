...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('client/' .$clients->id) }}" method="post">
        ...
        <input type="password" name="password" id="password" value="{{$clients->password}}" class="form-control"></br>
        <label>NumTelephone</label></br>
        <input type="text" name="NumTelephone" id="NumTelephone" value="{{$clients->NumTelephone}}" class="form-control"></br>
