...
import { DevisPreviewService } from './devis-preview.service';
...
export class DevisPreviewComponent implements OnInit, OnDestroy {
   // public
   public apiData;
   public urlLastValue;
   ...
   constructor(
     ...
     private _invoicePreviewService: DevisPreviewService,
