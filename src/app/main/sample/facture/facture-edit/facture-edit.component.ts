...
import { FactureEditService } from 'app/main/sample/facture/facture-edit/facture-edit.service';
@Component({
  selector: 'app-facture-edit',
  templateUrl: './facture-edit.component.html',
  styleUrls: ['./facture-edit.component.scss']
})
export class FactureEditComponent implements OnInit, OnDestroy {
  // public
   ...
   */
  constructor(private _invoiceAddService: FactureEditService, private _coreSidebarService: CoreSidebarService) {
